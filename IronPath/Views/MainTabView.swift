...
struct WorkoutView: View {
        ...
        NavigationStack {
            ...
            .sheet(isPresented: $showWorkoutSetup) {
                WorkoutSetupView(
                    ...
                    onGenerate: { workoutType, notes in
                        generateWorkout(workoutType: workoutType, notes: notes)
                    }
                )
            }
    ...
    private func generateWorkout(workoutType: WorkoutType, notes: String) {
        guard let profile = appState.userProfile else {
            errorMessage = "Please complete onboarding first"
            showError = true
            return
...
struct WorkoutSetupView: View {
    ...
    let onGenerate: (WorkoutType, String) -> Void
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button {
                        onGenerate(selectedWorkoutType, workoutNotes)
                    } label: {
                        if isGenerating {
                            ProgressView()
                        } else {
